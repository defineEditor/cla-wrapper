...
class CoreObject {
     ...
     * @param {String} username CDISC Library username. Used in case of Basic Authentication.
     * @param {String} password CDISC Library password. Used in case of Basic Authentication.
     * @param {String} apiKey CDISC Library API primary key. Used in case of OAuth2 Authentication.
     ...
     */
    constructor ({ username, password, apiKey, baseUrl, cache, traffic } = {}) {
...
class CdiscLibrary {
     ...
     * @param {Object} params
     * @param {String} params.username CDISC Library username. Used in case of Basic Authentication.
     * @param {String} params.password CDISC Library password. Used in case of Basic Authentication.
     * @param {String} params.apiKey CDISC Library API primary key. Used in case of OAuth2 Authentication.
     ...
     */
    constructor ({ username, password, apiKey, baseUrl, cache, traffic, productClasses } = {}) {
